...
AP_LIBS = /home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/pcre/libpcre.la /home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr-util/libaprutil-1.la /home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr-util/xml/expat/libexpat.la /home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20
...
EXTRA_LDFLAGS =
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr/include -I/home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr-util/include -I/home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr-util/xml/expat/lib -I$(top_srcdir)/modules/proxy/../generators -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
...
MKDEP = $(CC) -MM
INSTALL_PROG_FLAGS =
DSO_MODULES = proxy proxy_connect proxy_ftp proxy_http proxy_scgi proxy_wstunnel proxy_ajp proxy_balancer
APR_BINDIR = /usr/local/apache2/bin
APR_INCLUDEDIR = /home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr/include
APR_VERSION = 1.4.9
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /home/bogdan/GWFax/faxgwiseWeb_NEW/httpd-2.2.20/srclib/apr-util/include
APU_VERSION = 1.3.13
